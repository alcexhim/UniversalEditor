...
namespace MBS.Framework.UserInterface.Engines.WindowsForms.Internal.Linux.GLib
{
	internal class Constants
	{
		public struct GType : IEquatable<GType>
		{
			...
			{
				return new GType(GObject.Methods.g_type_from_name(native_name));
			}
			...
			public static Type LookupType(IntPtr typeid)
			{
				...
				string cname = GObject.Methods.g_type_name(typeid);
			...
			public override string ToString()
			{
				...
				sb.Append(GObject.Methods.g_type_name(val));
				return sb.ToString();
			}
