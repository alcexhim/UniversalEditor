...
namespace MBS.Framework.UserInterface.Engines.WindowsForms.Controls.Internal.CommandBars
{
	public class ToolBarManager : IMessageFilter
	{
		...
		// Added by mav
		public ToolBarDockHolder AddControl(System.Windows.Forms.Control c, DockStyle site)
		{
			return AddControl(c, site, null, DockStyle.Right);
		}

		public ToolBarDockHolder AddControl(System.Windows.Forms.Control c)
		{
		...
		private void ToolBarMouseDown(object sender, MouseEventArgs e)
		{
			...
			{
				_ptStart = System.Windows.Forms.Control.MousePosition;
		...
		private void ToolBarMouseMove(object sender, MouseEventArgs e)
		{
			...
			if(_dragged != null)
			{
				Point ptDelta = new Point(_ptStart.X - System.Windows.Forms.Control.MousePosition.X, _ptStart.Y - System.Windows.Forms.Control.MousePosition.Y);
				...
				if(docked != null)
				{
					if(closest == null) 
					{
						...
						_dragged.FloatForm.Location = new Point(System.Windows.Forms.Control.MousePosition.X-_ptOffset.X, System.Windows.Forms.Control.MousePosition.Y-8);
