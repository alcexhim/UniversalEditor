...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class VS2012DockPaneCaption : DockPaneCaptionBase
    {
        ...
        private InertButtonBase ButtonClose
        {
            get
            {
                if (m_buttonClose == null)
                {
                    ...
                    m_buttonClose.MouseClick += Close_MouseClick;
        ...
        private InertButtonBase ButtonAutoHide
        {
            get
            {
                if (m_buttonAutoHide == null)
                {
                    ...
                    m_buttonAutoHide.MouseClick += AutoHide_MouseClick;
        ...
        private void DrawCaption(Graphics g)
		{
			...
			MBS.Framework.UserInterface.Engines.WindowsForms.Theming.Theme.CurrentTheme.DrawDockPanelTitleBarBackground(g, ClientRectangle, DockPane.IsActivePane);
        ...
        private void AutoHide_MouseClick(object sender, MouseEventArgs e)
        {
			if (e.Button == MouseButtons.Left)
			{
