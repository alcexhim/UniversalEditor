...
namespace UniversalEditor.DataFormats.PropertyList.UniversalPropertyList
{
    public class UniversalPropertyListDataFormat : DataFormat
    {
        ...
        protected override void SaveInternal(ObjectModel objectModel)
        {
            ...
            bw.WriteSingle(mvarFormatVersion);
        ...
        private VariantType GetVariantType(object p)
        {
            ...
            if (p.GetType() == typeof(Boolean)) return VariantType.Boolean;
            if (p.GetType() == typeof(Byte)) return VariantType.Byte;
            if (p.GetType() == typeof(Char)) return VariantType.Char;
            if (p.GetType() == typeof(DateTime)) return VariantType.DateTime;
            if (p.GetType() == typeof(Decimal)) return VariantType.Decimal;
            if (p.GetType() == typeof(Double)) return VariantType.Double;
            if (p.GetType() == typeof(Guid)) return VariantType.Guid;
            if (p.GetType() == typeof(Int16)) return VariantType.Int16;
            if (p.GetType() == typeof(Int32)) return VariantType.Int32;
            if (p.GetType() == typeof(Int64)) return VariantType.Int64;
            if (p.GetType() == typeof(SByte)) return VariantType.SByte;
            if (p.GetType() == typeof(Single)) return VariantType.Single;
            if (p.GetType() == typeof(String)) return VariantType.String;
            if (p.GetType() == typeof(UInt16)) return VariantType.UInt16;
            if (p.GetType() == typeof(UInt32)) return VariantType.UInt32;
            if (p.GetType() == typeof(UInt64)) return VariantType.UInt64;
