...
namespace UniversalEditor.Plugins.Multimedia.DataFormats.Picture.Targa
{
	public class TrueVisionTGADataFormat : DataFormat
	{
		...
		protected override void LoadInternal(ref ObjectModel objectModel)
		{
								...
								for (int i = 0; i < colorMapLength; i++)
								{
									...
									switch (colorMapEntrySize)
									{
										...
										case 24:
										{
											...
											pic.ColorMap.Add(System.Drawing.Color.FromArgb(r, g, b));
											break;
										}
										case 32:
										{
											...
											g = Convert.ToInt32(br.ReadByte());
											r = Convert.ToInt32(br.ReadByte());
											pic.ColorMap.Add(System.Drawing.Color.FromArgb(a, r, g, b));
											break;
										}
										default:
										{
			...
			#region Targa extension area
			{
				...
				if (!br.EndOfStream && (extensionAreaOffset > 0))
				{
					...
					mvarExtensionArea.ColorKey = (System.Drawing.Color.FromArgb(a, r, g, b));
					...
					if (extensionAreaColorCorrectionOffset > 0)
					{
						...
						for (int i = 0; i < EXTENSION_AREA_COLOR_CORRECTION_TABLE_VALUE_LENGTH; i++)
						{
							...
							b = (int)br.ReadInt16();
							g = (int)br.ReadInt16();
							mvarExtensionArea.ColorCorrectionTable.Add(System.Drawing.Color.FromArgb(a, r, g, b));
						}
					}
				}
			}
		...
		/// </remarks>
		private static System.Drawing.Color GetColorFrom2Bytes(byte one, byte two)
		{
