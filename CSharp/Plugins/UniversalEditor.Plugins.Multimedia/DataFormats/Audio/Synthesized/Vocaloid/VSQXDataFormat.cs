...
namespace UniversalEditor.Plugins.Multimedia.DataFormats.Audio.Synthesized.Vocaloid
{
	public class VSQXDataFormat : XMLDataFormat
	{
						...
						if (text != null)
						{
							if (!(text == "vender"))
							{
								...
								else
								{
									...
									if (tagCDATA != null)
									{
										au.Information.GeneratorVersion = new Version(tagCDATA.Value);
									}
								}
							}
							else
							{
								...
								if (tagCDATA != null)
								{
									au.Information.GeneratorAuthor = tagCDATA.Value;
								}
							}
						}
					}
		...
		protected override void BeforeSaveInternal(Stack<ObjectModel> objectModels)
		{
			...
			tagVenderCDATA.Value = au.Information.GeneratorAuthor;
			...
			tagVersionCDATA.Value = au.Information.GeneratorVersion.ToString();
