...
namespace UniversalEditor.Plugins.CRI.DataFormats.FileSystem.CPK
{
	public class CPKDataFormat : DataFormat
	{
		...
		private DatabaseObjectModel BuildHeaderUTF(FileSystemObjectModel fsom, int tocsize, ulong contentOffset, ulong contentSize, ulong etocOffset, ulong etocLength, ulong itocOffset, ulong itocLength)
		{
			...
			dt.Fields.Add("TocCrc", null, typeof(Int32));
			...
			dt.Fields.Add("Tocs", null, typeof(Int32));
			dt.Fields.Add("Files", null, typeof(Int32));
			dt.Fields.Add("Groups", null, typeof(Int32));
			dt.Fields.Add("Attrs", null, typeof(Int32));
			dt.Fields.Add("TotalFiles", null, typeof(Int32));
			dt.Fields.Add("Directories", null, typeof(Int32));
			dt.Fields.Add("Updates", null, typeof(Int32));
			...
			dt.Fields.Add("CpkMode", null, typeof(Int32));
			dt.Fields.Add("Tvers", null, typeof(string));
			dt.Fields.Add("Comment", null, typeof(string));
			dt.Fields.Add("Codec", null, typeof(Int32));
			dt.Fields.Add("DpkItoc", null, typeof(Int32));
