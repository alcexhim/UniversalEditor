...
namespace UniversalEditor.ObjectModels.Multimedia3D.Model
{
	public class ModelMaterial : ICloneable
	{
		...
		private Color mvarDiffuseColor = Color.FromArgb(0, 0, 0, 0);
        private Color mvarEmissiveColor = Color.FromArgb(0, 0, 0, 0);
        private Color mvarSpecularColor = Color.FromArgb(0, 0, 0, 0);
		private Color mvarAmbientColor = Color.FromArgb(0, 0, 0, 0);
		...
		private bool mvarEnableLightSource = false;
		public bool EnableLightSource { get { return mvarEnableLightSource; } set { mvarEnableLightSource = value; } }
