...
namespace UniversalEditor.DataFormats.NewWorldComputing.AGG
{
	public class AGGDataFormat : DataFormat
	{
		...
		protected override void LoadInternal(ref ObjectModel objectModel)
		{
            ...
            Internal.AGGFileEntry[] files = new Internal.AGGFileEntry[fileCount];
        ...
        void file_DataRequest(object sender, DataRequestEventArgs e)
        {
            ...
            Internal.AGGFileEntry entry = (Internal.AGGFileEntry)file.Properties["InternalData"];
            ...
            uint hash = UniversalEditor.Common.Hashing.CRC32.Calculate(e.Data);
