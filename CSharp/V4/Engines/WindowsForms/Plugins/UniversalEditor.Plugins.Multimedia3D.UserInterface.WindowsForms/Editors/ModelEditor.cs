...
namespace UniversalEditor.Plugins.Multimedia3D.UserInterface.WindowsForms.Editors
{
    public partial class ModelEditor : Editor
    {
		...
		public override void Refresh()
		{
			...
			tv.Nodes["nodeBones"].Nodes.Clear();
			tv.Nodes["nodeMaterials"].Nodes.Clear();
			...
			foreach (ModelBoneGroup group in model.BoneGroups)
			{
				...
				tv.Nodes["nodeBones"].Nodes.Add(tnGroup);
			}
			...
			foreach (ModelMaterial mat in model.Materials)
			{
				...
				tnMat.Text = mat.Name;
				tnMat.Tag = mat;
				tv.Nodes["nodeMaterials"].Nodes.Add(tnMat);
			}
		}
        ...
        private void tv_AfterSelect(object sender, TreeViewEventArgs e)
        {
            if (tv.SelectedNode != null)
            {
                if (tv.SelectedNode.Tag is ModelMaterial)
                {
                    ...
                    pnlColorAmbient.BackColor = mat.AmbientColor;
                    pnlColorDiffuse.BackColor = mat.DiffuseColor;
                    pnlColorSpecular.BackColor = mat.SpecularColor;
                    pnlColorEmissive.BackColor = mat.EmissiveColor;
                    pnlColorEdge.BackColor = mat.EdgeColor;

					chkMaterialEnableAnimation.Checked = mat.EnableAnimation;
					chkMaterialEnableLightSource.Checked = mat.EnableLightSource;
		...
		private void chkMaterialFlags_CheckedChanged(object sender, EventArgs e)
		{
			...
			mat.EnableLightSource = chkMaterialEnableLightSource.Checked;
		}
		...
		private void txtGroupName_Validated(object sender, EventArgs e)
		{
			...
			OnObjectModelEditing(EventArgs.Empty);
			grp.Name = txtGroupName.Text;
			tv.SelectedNode.Text = grp.Name;
			OnObjectModelEdited(EventArgs.Empty);
		}
