namespace UniversalEditor.UserInterface.WindowsForms.Pages
{
    partial class ExplorerPage
    {
        ...
        {
            this.explorer = new UniversalEditor.UserInterface.WindowsForms.Controls.LocalFileSystemExplorer();
            this.SuspendLayout();
            // 
            // explorer
            // 
            ...
            this.explorer.Navigate += new UniversalEditor.UserInterface.WindowsForms.Controls.NavigateEventHandler(this.explorer_Navigate);
            // 
            // ExplorerPage
            // 
        ...
        private Controls.LocalFileSystemExplorer explorer;
