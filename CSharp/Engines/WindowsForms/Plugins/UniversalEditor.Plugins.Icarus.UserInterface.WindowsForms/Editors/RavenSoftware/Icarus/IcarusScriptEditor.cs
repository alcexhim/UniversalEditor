...
using UniversalEditor.ObjectModels.RavenSoftware.Icarus;
using UniversalEditor.ObjectModels.RavenSoftware.Icarus.Commands;
...
namespace UniversalEditor.Editors.RavenSoftware.Icarus
{
    public partial class IcarusScriptEditor : Editor
    {
        ...
        private void tv_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (tn != null)
            {
                Dialogs.RavenSoftware.Icarus.IcarusExpressionHelperDialog dlg = new Dialogs.RavenSoftware.Icarus.IcarusExpressionHelperDialog();
