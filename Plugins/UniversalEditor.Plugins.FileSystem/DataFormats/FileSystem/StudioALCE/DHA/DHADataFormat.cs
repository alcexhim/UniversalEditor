...
namespace UniversalEditor.DataFormats.FileSystem.StudioALCE.DHA
{
    /// <summary>
    /// The DHA format is capable of loading/saving a FileSystemObjectModel for my visual novel projects. It stands
    /// for "Denys Hernandez Archive" ;)
    /// </summary>
