//
//  XCOFF32DataFormat.cs - provides a DataFormat for manipulating 32-bit Extended Common Object File Format executables
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating 32-bit Extended Common Object File Format executables.
	/// </summary>
	public class XCOFF32DataFormat : XCOFFDataFormat
	{
		...
		/// </value>
		public ushort MagicNumber { get; set; } = 0x01DF;
		/// <value>
		...
		/// </value>
		public uint SymbolicPointer { get; set; } = 0;
