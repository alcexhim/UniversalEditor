...
#if ZZYZX
namespace UniversalEditor.Plugins.Multimedia3D.DataFormats.RIFFExtensibleModel
{
	public class RMDModelDataFormat : RIFFDataFormat
	{
		...
		protected override void BeforeSaveInternal(Stack<ObjectModel> objectModels)
        {
            ...
            #region Vertex Data
            {
                ...
                IO.BinaryWriter bwMVTX = new IO.BinaryWriter(msMVTX);
            ...
            #region PMA Extensions
            {
                ...
                IO.BinaryWriter bwPMAV = new IO.BinaryWriter(msPMAV);
