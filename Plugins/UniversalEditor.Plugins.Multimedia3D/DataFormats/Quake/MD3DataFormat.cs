...
namespace UniversalEditor.Plugins.Multimedia3D.DataFormats.Quake
{
	public class MD3DataFormat : DataFormat
	{
		...
		protected override void LoadInternal(ref ObjectModel objectModel)
        {
            ...
            br.BaseStream.Position = offsetToFrames;
            ...
            br.BaseStream.Position = offsetToTags;
            ...
            br.BaseStream.Position = offsetToSurfaces;
        ...
        private void ReadSurface(BinaryReader br, ref ModelObjectModel model)
        {
            long offsetToStart = br.BaseStream.Position;
            ...
            // files).
            br.BaseStream.Position = offsetToStart + offsetToShaders;
            ...
            br.BaseStream.Position = offsetToStart + offsetToTriangles;
            ...
            br.BaseStream.Position = offsetToTextureCoordinates;
            for (int i = 0; i < numTriangles; i++)
            {
