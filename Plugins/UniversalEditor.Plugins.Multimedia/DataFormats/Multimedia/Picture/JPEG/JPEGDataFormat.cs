//
//  JPEGDataFormat.cs - provides a DataFormat for manipulating images in Joint Photographic Experts Group (JPEG) format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating images in Joint Photographic Experts Group (JPEG) format.
	/// </summary>
