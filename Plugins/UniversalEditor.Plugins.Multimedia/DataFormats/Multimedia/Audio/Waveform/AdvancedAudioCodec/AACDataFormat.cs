//
//  AACDataFormat.cs - provides a DataFormat for manipulating waveform audio files in AAC format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating waveform audio files in AAC format.
	/// </summary>
