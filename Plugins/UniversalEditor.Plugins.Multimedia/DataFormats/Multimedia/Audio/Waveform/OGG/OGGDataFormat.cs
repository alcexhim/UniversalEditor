//
//  OGGDataFormat.cs - provides a DataFormat for manipulating waveform audio in OGG format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating waveform audio in OGG format.
	/// </summary>
