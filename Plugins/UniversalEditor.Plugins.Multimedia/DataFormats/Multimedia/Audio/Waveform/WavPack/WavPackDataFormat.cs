//
//  WavPackDataFormat.cs - provides a DataFormat for manipulating waveform audio in WavPack format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating waveform audio in WavPack format.
	/// </summary>
