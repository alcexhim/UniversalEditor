//
//  ShortenDataFormat.cs - provides a DataFormat for manipulating waveform audio in Shorten format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating waveform audio in Shorten format.
	/// </summary>
