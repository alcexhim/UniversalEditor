//
//  MPLSDataFormat.cs - provides a DataFormat for manipulating files in Blu-Ray MPLS format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating files in Blu-Ray MPLS format.
	/// </summary>
