//
//  INDXDataFormat.cs - provides a DataFormat for manipulating files in Blu-Ray INDX format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating files in Blu-Ray INDX format.
	/// </summary>
