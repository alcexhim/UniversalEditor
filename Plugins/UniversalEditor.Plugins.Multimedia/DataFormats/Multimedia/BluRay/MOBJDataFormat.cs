//
//  MOBJDataFormat.cs - provides a DataFormat for manipulating files in Blu-Ray MOBJ format
//
//  Author:
...
{
	/// <summary>
	/// Provides a <see cref="DataFormat" /> for manipulating files in Blu-Ray MOBJ format.
	/// </summary>
